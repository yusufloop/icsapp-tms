...
export default function EditBookingScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-bg-primary">
        ...
        <View className="px-6 py-6 space-y-6">
          ...
          <View className="mt-8">
            ...
            <View className="mb-4">
              ...
              <TouchableOpacity
                onPress={() => setShowShipmentTypePicker(true)}
                className="rounded-lg bg-bg-secondary border border-gray-300 flex-row items-center px-4 py-3 min-h-[44px] active:opacity-80"
              >
            ...
            <View className="mb-4">
              ...
              <TouchableOpacity
                onPress={() => setShowContainerSizePicker(true)}
                className="rounded-lg bg-bg-secondary border border-gray-300 flex-row items-center px-4 py-3 min-h-[44px] active:opacity-80"
              >
      ...
      {/* Shipment Type Picker Modal */}
      {showShipmentTypePicker && (
        <View className="absolute inset-0 bg-black/50 justify-center items-center px-4">
          <View className="bg-bg-primary rounded-lg p-6 w-full max-w-sm">
            <Text className="text-lg font-semibold text-text-primary mb-4 text-center">Select Shipment Type</Text>
            {shipmentTypes.map((type, index) => (
              ...
              >
                <Text className="text-base text-text-primary text-center">{type}</Text>
              </TouchableOpacity>
            ))}
            <TouchableOpacity onPress={() => setShowShipmentTypePicker(false)} className="mt-4">
      ...
      {showContainerSizePicker && (
        <View className="absolute inset-0 bg-black/50 justify-center items-center px-4">
          <View className="bg-bg-primary rounded-lg p-6 w-full max-w-sm">
            <Text className="text-lg font-semibold text-text-primary mb-4 text-center">Select Container Size</Text>
            {containerSizes.map((size, index) => (
              <TouchableOpacity 
                ...
                className="py-3 border-b border-gray-200 last:border-b-0"
              >
                <Text className="text-base text-text-primary text-center">{size}</Text>
              </TouchableOpacity>
            ))}
            <TouchableOpacity onPress={() => setShowContainerSizePicker(false)} className="mt-4">
              <Text className="text-base text-text-secondary text-center">Cancel</Text>
            </TouchableOpacity>
          </View>
        </View>
